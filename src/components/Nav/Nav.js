...
const Nav = () => {
  ...
  useEffect(() => {
    const altNavParent = document.querySelector('[data-alt-nav="true"]');
    if (altNavParent) {
      setAltNav(true);
    }
  }, [router.asPath]);
  ...
  const toggleStyles = {
    wrapper: {
      color: navState.scrollState === 'scrollingUp' ? '#e2ddd0' : altNav ? '#352540' : '#e2ddd0',
    },
    line: {
      backgroundColor: navState.scrollState === 'scrollingUp' ? '#e2ddd0' : altNav ? '#352540' : '#e2ddd0',
    },
  };
      ...
      >
        <Section className={styles.navSection}>
          <Container className={styles.navContainer}>
            ...
            <div className={[styles.menuWrapper, 'menuToggle'].join(' ')} style={toggleStyles.wrapper}>
              <p>Menu</p>
              <div className={styles.menuIcon}>
                <div className={[styles.line, styles.line1].join(' ')} style={toggleStyles.line}></div>
                <div className={[styles.line, styles.line2].join(' ')} style={toggleStyles.line}></div>
              </div>
            </div>
          </Container>
        </Section>
